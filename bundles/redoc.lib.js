            ...
            for (let s in e) {
              ...
              for (let e in a)
                if (y.httpMethods.indexOf(e) >= 0 || 'x-amazon-apigateway-any-method' === e) {
                  ...
                  if ((p && p.security && R(p.security), 'object' == typeof p)) {
                    if (!p.responses) {
                ...
                D(o, t, n),
                  ...
                  h
                    ...
                    .then(function () {
                      (function (e, t) {
                        let r = {};
                        (v = { schemas: {} }), e.security && R(e.security);
    ...
    return (
      (function () {
            ...
            return void 0 === r
              ...
              : (j(e) &&
                  ...
                  Object.keys(r).forEach(t => {
                    j(r[t]) ? (e[t] || (e[t] = {}), R(e[t], r[t])) : (e[t] = r[t]);
                  }),
                R(e, ...t));
          },
        ...
        var N = Object.defineProperty,
          ...
          U = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          W = (e, t) => {
            for (var r in t || (t = {})) B.call(t, r) && U(e, r, t[r]);
            if (z) for (var r of z(t)) Q.call(t, r) && U(e, r, t[r]);
            return e;
          },
          V = (e => ((e.SummaryOnly = 'summary-only'), (e.PathOnly = 'path-only'), e))(V || {});
        function H(e, t) {
        ...
        class Y {
          ...
          constructor(e, t = {}) {
            var r, n, o, s, a, l;
            const c = (e = W(W({}, t), e)).theme && e.theme.extensionsHook;
            var p, u;
            (null == (r = e.theme) ? void 0 : r.menu) &&
              ...
              })(R({}, i, ((p = W({}, e.theme)), q(p, F({ extensionsHook: void 0 })))))),
              (this.theme.extensionsHook = c),
              (u = e.labels),
              Object.assign(D, u),
              (this.scrollYOffset = Y.normalizeScrollYOffset(e.scrollYOffset)),
              (this.hideHostname = Y.normalizeHideHostname(e.hideHostname)),
              (this.expandResponses = Y.normalizeExpandResponses(e.expandResponses)),
              (this.requiredPropsFirst = H(e.requiredPropsFirst)),
              (this.sortPropsAlphabetically = H(e.sortPropsAlphabetically)),
              (this.sortEnumValuesAlphabetically = H(e.sortEnumValuesAlphabetically)),
              (this.sortOperationsAlphabetically = H(e.sortOperationsAlphabetically)),
              (this.sortTagsAlphabetically = H(e.sortTagsAlphabetically)),
              (this.noAutoAuth = H(e.noAutoAuth)),
              (this.nativeScrollbars = H(e.nativeScrollbars)),
              (this.pathInMiddlePanel = H(e.pathInMiddlePanel)),
              (this.untrustedSpec = H(e.untrustedSpec)),
              (this.hideDownloadButton = H(e.hideDownloadButton)),
              (this.disableSearch = H(e.disableSearch)),
              (this.onlyRequiredInSamples = H(e.onlyRequiredInSamples)),
              (this.showExtensions = Y.normalizeShowExtensions(e.showExtensions)),
              (this.sideNavStyle = Y.normalizeSideNavStyle(e.sideNavStyle)),
              (this.hideSingleRequestSampleTab = H(e.hideSingleRequestSampleTab)),
              (this.menuToggle = H(e.menuToggle, !0)),
              (this.jsonSampleExpandLevel = Y.normalizeJsonSampleExpandLevel(
                e.jsonSampleExpandLevel,
              )),
              (this.enumSkipQuotes = H(e.enumSkipQuotes)),
              (this.hideSchemaTitles = H(e.hideSchemaTitles)),
              (this.simpleOneOfTypeLabel = H(e.simpleOneOfTypeLabel)),
              (this.payloadSampleIdx = Y.normalizePayloadSampleIdx(e.payloadSampleIdx)),
              (this.expandSingleSchemaField = H(e.expandSingleSchemaField)),
              (this.schemaExpansionLevel = (function (e, t = 0) {
                return 'all' === e ? 1 / 0 : J(e) || t;
              })(e.schemaExpansionLevel)),
              (this.showObjectSchemaExamples = H(e.showObjectSchemaExamples)),
              (this.unstable_ignoreMimeParameters = H(e.unstable_ignoreMimeParameters)),
              (this.allowedMdComponents = e.allowedMdComponents || {}),
              (this.expandDefaultServerVariables = H(e.expandDefaultServerVariables)),
              (this.maxDisplayedEnumValues = J(e.maxDisplayedEnumValues));
            const d = Array.isArray(e.ignoreNamedSchemas)
              ? e.ignoreNamedSchemas
              : null == (a = e.ignoreNamedSchemas)
              ? void 0
              : a.split(',').map(e => e.trim());
            this.ignoreNamedSchemas = new Set(d);
            const m = Array.isArray(e.codeSamplesLanguage)
              ? e.codeSamplesLanguage
              : null == (l = e.codeSamplesLanguage)
              ? void 0
              : l.split(',').map(e => e.trim());
            (this.codeSamplesLanguage = new Set(m)),
              (this.hideSchemaPattern = H(e.hideSchemaPattern)),
              (this.generatedPayloadSamplesMaxDepth = Y.normalizeGeneratedPayloadSamplesMaxDepth(
                e.generatedPayloadSamplesMaxDepth,
              ));
          }
        }
        var G = require('styled-components');
        const { default: X, css: Z, createGlobalStyle: K, keyframes: ee, ThemeProvider: te } = G,
          re = {
            lessThan:
              (e, t, r) =>
              (...n) =>
          ...
          render() {
            return this.state.error
              ? e.createElement(
                  ...
                  e.createElement('small', null, ' ReDoc Version: ', '2.0.0-rc.63'),
                  ' ',
                  e.createElement('br', null),
                  e.createElement('small', null, ' Commit: ', '57cdd9f6'),
                )
...
`,
  ...
  color: ${e => e.color};
`;
        class pe extends e.PureComponent {
          render() {
            return e.createElement(
              'div',
              { style: { textAlign: 'center' } },
              e.createElement(ce, { color: this.props.color }, 'Loading ...'),
              e.createElement(le, { color: this.props.color }),
            );
          }
        }
        var ue = require('prop-types');
        const de = e.createContext(new Y({})),
          me = de.Provider,
          he = de.Consumer;
        var fe = require('mobx'),
          ye = require('@redocly/openapi-core/lib/bundle'),
          ge = require('@redocly/openapi-core/lib/config/config'),
          be = r(925);
        function xe(e) {
          return (
            (t = this),
        ...
        var we = require('decko'),
          Oe = require('eventemitter3'),
          Ee = require('json-pointer');
        const ke = Ee.parse;
        class Se {
          ...
          static dirName(e, t = 1) {
            const r = Se.parse(e);
            return Ee.compile(r.slice(0, r.length - t));
          }
          static relative(e, t) {
            const r = Se.parse(e);
        ...
        (Ee.parse = Se.parse), Object.assign(Se, Ee);
        var Re = r(622),
        ...
        function Ne(e) {
          return 'default' === e || k(e) || Me(e);
        }
        function qe(e, t = !1) {
          if ('default' === e) return t ? 'error' : 'success';
          let r = 'string' == typeof e ? parseInt(e, 10) : e;
          if ((Me(e) && (r *= 100), r < 100 || r > 599)) throw new Error('invalid HTTP code');
          let n = 'success';
          return (
            r >= 300 && r < 400
              ? (n = 'redirect')
            ...
            void 0 === e
              ? T(
                  (() => {
                    ...
                    return e.endsWith('.html') ? (0, Re.dirname)(e) : e;
                  })(),
                )
              : (0, Re.dirname)(e);
          return (
        ...
        const ht = 'security-definitions',
          ft = 'SecurityDefinitions',
          yt = 'SchemaDefinition';
        let gt = 'section/Authentication/';
        function bt(e) {
          gt = e;
        }
        ...
        function Rt(e, t = 'clike') {
          t = t.toLowerCase();
          let r = kt.languages[t];
          return r || (r = kt.languages[St(t)]), kt.highlight(e.toString(), r, t);
        }
        function jt(e) {
          return (t, r, n) => {
        ...
        class Wt {
          constructor() {
            (this.emit = () => {
              ...
              (this._emiter = new Oe.EventEmitter()),
              this.bind();
          }
          get currentId() {
        ...
        var Yt = require('marked'),
          ...
          rr = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          nr = (e, t) => {
            for (var r in t || (t = {})) er.call(t, r) && rr(e, r, t[r]);
            if (Kt) for (var r of Kt(t)) tr.call(t, r) && rr(e, r, t[r]);
            return e;
          };
        const or = new Yt.marked.Renderer();
        Yt.marked.setOptions({ renderer: or, highlight: (e, t) => Rt(e, t) });
        const ir = '^ {0,3}\x3c!-- ReDoc-Inject:\\s+?<({component}).*?/?>\\s+?--\x3e\\s*$',
          sr =
        ...
        class cr {
          constructor(e) {
            (this.options = e),
              ...
              (this.parser = new Yt.marked.Parser()),
              (this.headingEnhanceRenderer = new Yt.marked.Renderer()),
          ...
          static containsComponent(e, t) {
            return new RegExp(ar.replace(/{component}/g, t), 'gmi').test(e);
          }
          ...
          renderMd(e, t = !1) {
            ...
            return (0, Yt.marked)(e.toString(), r);
          }
          extractHeadings(e) {
          ...
          renderMdWithComponents(e) {
            ...
            const r = Object.keys(t).join('|'),
              n = new RegExp(ar.replace(/{component}/g, r), 'mig'),
              o = [],
              i = [];
            let s = n.exec(e),
              a = 0;
            for (; s; ) {
              ...
              r &&
                i.push({
                  ...
                  props: ((l = nr(nr({}, pr(p)), r.props)), (c = { children: u }), Xt(l, Zt(c))),
                }),
                (s = n.exec(e));
            }
            var l, c;
            ...
            this.schemes = Object.keys(e || {})
              .map(n => {
                ...
                if (o)
                  return (
                    (s = ((e, t) => {
                      for (var r in t || (t = {})) yr.call(t, r) && br(e, r, t[r]);
                      if (fr) for (var r of fr(t)) gr.call(t, r) && br(e, r, t[r]);
                      return e;
                    })({}, o)),
                    mr(s, hr({ id: n, sectionId: gt + n, scopes: i }))
                  );
                console.warn(`Non existing security scheme referenced: ${n}. Skipping`);
              })
              .filter(e => void 0 !== e);
          }
        }
        var vr = require('openapi-snippet'),
          ...
          $r = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Cr = (e, t) => {
            for (var r in t || (t = {})) Rr.call(t, r) && $r(e, r, t[r]);
            if (Sr) for (var r of Sr(t)) jr.call(t, r) && $r(e, r, t[r]);
            return e;
          },
          Pr = (e, t, r, n) => {
        ...
        Pr([fe.observable], Ar.prototype, 'expanded', 2),
          Pr([fe.action], Ar.prototype, 'toggle', 1);
        var Ir = Object.defineProperty,
          ...
          qr = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Fr = (e, t) => {
            for (var r in t || (t = {})) Mr.call(t, r) && qr(e, r, t[r]);
            if (Dr) for (var r of Dr(t)) Nr.call(t, r) && qr(e, r, t[r]);
            return e;
          },
          zr = (e, t) => Tr(e, Lr(t)),
          Br = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? _r(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
        ...
        const Qr = class {
          ...
          init(e, t) {
            ...
            if (
              ...
              (this.title = r.title || (nt(this.pointer) && Se.baseName(this.pointer)) || ''),
              (this.description = r.description || ''),
              (this.type = r.type || Ue(r)),
              ...
              (this.constraints = at(r)),
              (this.displayFormat = this.format),
              (this.isPrimitive = We(r, this.type)),
              ...
              if (t || void 0 === Wr(r)) {
                ...
                if (this.hasType('object'))
                  this.fields = (function (e, t, r, n) {
                    ...
                    return (
                      n.sortPropsAlphabetically && (a = ct(a, 'name')),
                      n.requiredPropsFirst &&
                        (a = lt(a, n.sortPropsAlphabetically ? void 0 : t.required)),
                      ('object' != typeof i && !0 !== i) ||
                        a.push(
                          new Zr(
                            e,
                  ...
                  (this.displayType = Ot(this.items.displayType)),
                  (this.displayFormat = this.items.format),
                  (this.typePrefix = this.items.typePrefix + M('arrayOf')),
              ...
              ((this.oneOf = e.map((e, r) => {
                const n = t.deref(e, !1, !0),
                  ...
                  s = new Qr(
                    ...
                    zr(Fr({}, o), {
                      title: i,
                      allOf: [zr(Fr({}, this.schema), { oneOf: void 0, anyOf: void 0 })],
                    }),
        ...
        Br([fe.observable], Ur.prototype, 'activeOneOf', 2),
          Br([fe.action], Ur.prototype, 'activateOneOf', 1);
        const Vr = {};
        class Hr {
          constructor(e, t, r, n) {
            this.mime = r;
        ...
        class Zr {
          constructor(e, t, r, n) {
            ...
            !p &&
              ...
              e.exitRef(t),
              n.showExtensions && (this.extensions = wt(c, n.showExtensions)),
              (this.const =
        ...
        Gr([fe.observable], Zr.prototype, 'expanded', 2),
          Gr([fe.action], Zr.prototype, 'toggle', 1),
          Gr([fe.action], Zr.prototype, 'collapse', 1),
          Gr([fe.action], Zr.prototype, 'expand', 1);
        ...
        nn([fe.observable], on.prototype, 'activeMimeIdx', 2),
          nn([fe.action], on.prototype, 'activate', 1),
          nn([fe.computed], on.prototype, 'active', 1);
        class sn {
        ...
        fn([fe.observable], yn.prototype, 'expanded', 2),
          fn([fe.action], yn.prototype, 'toggle', 1);
        ...
        class On {
          constructor(e, t, r, n, o = !1) {
            (this.parser = e),
              ...
              (this.name = Be(t)),
              (this.sidebarLabel = n.sideNavStyle === V.PathOnly ? this.path : this.name),
              this.isCallback
                ? ((this.security = (t.security || []).map(t => new xr(t, e))),
                  (this.servers = mt('', t.servers || t.pathServers || [])))
                : ((this.id =
          ...
          get codeSamples() {
            let e = this.parser.spec;
            e.servers = this.servers;
            const t = Array.from(this.options.codeSamplesLanguage);
            let r = [];
            this.isCallback ||
              this.isEvent ||
              this.isWebhook ||
              !t.length ||
              (r = vr
                .getEndpointSnippets(e, this.operationSpec.pathName, this.operationSpec.httpVerb, t)
                .snippets.map(e => ({ lang: e.title, source: decodeURI(e.content) })));
            let n =
              this.operationSpec['x-codeSamples'] || this.operationSpec['x-code-samples'] || r;
            this.operationSpec['x-code-samples'] &&
              !wn &&
              ((wn = !0),
              console.warn('"x-code-samples" is deprecated. Use "x-codeSamples" instead'));
            const o = this.requestBody && this.requestBody.content;
            if (o && o.hasSample) {
              const e = Math.min(n.length, this.options.payloadSampleIdx);
              n = [
                ...n.slice(0, e),
                { lang: 'payload', label: 'Payload', source: '', requestBodyContent: o },
                ...n.slice(e),
              ];
            }
            return n;
          ...
          get responses() {
            ...
            return Object.keys(this.operationSpec.responses || [])
              .filter(t => 'default' === t || ('success' === qe(t) && (e = !0), Ne(t)))
              .map(
                t =>
                  new yn({
                    parser: this.parser,
        ...
        xn([fe.observable], On.prototype, 'ready', 2),
          xn([fe.observable], On.prototype, 'active', 2),
          xn([fe.observable], On.prototype, 'expanded', 2),
          xn([fe.action], On.prototype, 'activate', 1),
          xn([fe.action], On.prototype, 'deactivate', 1),
          xn([fe.action], On.prototype, 'toggle', 1),
          xn([Ft], On.prototype, 'requestBody', 1),
          xn([Ft], On.prototype, 'codeSamples', 1),
          xn([Ft], On.prototype, 'parameters', 1),
          xn([Ft], On.prototype, 'responses', 1),
          xn([Ft], On.prototype, 'callbacks', 1);
        var En = Object.defineProperty,
          ...
          Pn = (e, t) => {
            ...
            if (Rn) for (var r of Rn(t)) $n.call(t, r) && Cn(e, r, t[r]);
            return e;
          };
        class An {
          constructor(e, t, r) {
          ...
          initWebhooks(e, t, r) {
            for (const o of Object.keys(t)) {
              ...
              for (const t of s) {
                ...
                if (!o) continue;
                const s = new On(e, ((n = Pn({}, o)), kn(n, Sn({ httpVerb: t }))), void 0, r, !1);
        ...
        var _n = Object.defineProperty,
          ...
          Fn = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          zn = (e, t) => {
            for (var r in t || (t = {})) Nn.call(t, r) && Fn(e, r, t[r]);
            if (Mn) for (var r of Mn(t)) qn.call(t, r) && Fn(e, r, t[r]);
            return e;
          };
        class Bn {
          constructor() {
        ...
        class Qn {
          ...
          preprocess(e) {
            if (
              ...
              if (!cr.containsComponent(t, ht) && !cr.containsComponent(t, ft)) {
                const r = lr(ht);
                e.info.description = S(t, 'Authentication', r);
              }
            }
          }
          isRef(e) {
          ...
          mergeRefs(e, t, r) {
            const n = e,
              ...
              i = ((e, t) => {
                ...
                if (null != e && Mn)
                  for (var n of Mn(e)) t.indexOf(n) < 0 && qn.call(e, n) && (r[n] = e[n]);
                return r;
              })(n, ['$ref']),
              s = Object.keys(i);
            return 0 === s.length
          ...
          mergeAllOf(e, t, r = !1, n = new Set()) {
            ...
            let o =
              ((i = zn({}, e)),
              (s = { allOf: void 0, parentRefs: [], title: e.title || ot(t) }),
              Ln(i, Dn(s)));
            var i, s;
            void 0 !== o.properties &&
            ...
            for (const { $ref: e, schema: r } of a) {
              ...
              void 0 !== r.items &&
                ...
                (o = zn(zn({}, r), o)),
                e && (o.parentRefs.push(e), void 0 === o.title && nt(e));
            }
            return o;
          }
          findDerived(e) {
        ...
        class eo {
          constructor(e, t, r) {
            ...
            n &&
              n.length &&
              (this.description = cr.getTextBeforeHading(this.description, n[0].name)),
              (this.parent = r),
              (this.externalDocs = t.externalDocs),
        ...
        Kn([fe.observable], eo.prototype, 'active', 2),
          Kn([fe.observable], eo.prototype, 'expanded', 2),
          Kn([fe.action], eo.prototype, 'activate', 1),
          Kn([fe.action], eo.prototype, 'expand', 1),
          Kn([fe.action], eo.prototype, 'collapse', 1),
          Kn([fe.action], eo.prototype, 'deactivate', 1);
        ...
        class uo {
          ...
          static addMarkdownItems(e, t, r, n) {
            const o = new cr(n).extractHeadings(e || '');
            o.length &&
              t &&
              t.description &&
              (t.description = cr.getTextBeforeHading(t.description, o[0].name));
            const i = (e, t, r = 1) =>
              t.map(t => {
                ...
                return (
                  ...
                  cr.containsComponent(n.description || '', ht) && bt(n.id + '/'),
                  n
                );
              });
            return i(t, o, r);
          ...
          static getTagsItems(e, t, r, n, o) {
            ...
            return o.sortTagsAlphabetically && a.sort(zt('name')), a;
          }
          static getOperationsItems(e, t, r, n, o) {
            ...
            return o.sortOperationsAlphabetically && i.sort(zt('name')), i;
          }
        ...
        class go {
              ...
              (this.updateOnHistory = (e = this.history.currentId) => {
                ...
                (t = this.flatItems.find(t => t.id === e)),
                  t
                    ...
                    : (e.startsWith(gt) &&
                        ((t = this.flatItems.find(e => gt.startsWith(e.id))), this.activate(t)),
                      this.scroll.scrollIntoViewBySelector(`[${yo}="${e}"]`));
              }),
          ...
          static updateOnHistory(e = Vt.currentId, t) {
            e && t.scrollIntoViewBySelector(`[${yo}="${e}"]`);
          }
          subscribe() {
          ...
          getElementAt(e) {
            ...
            return (t && a(`[${yo}="${t.id}"]`)) || null;
          }
          getElementAtOrFirstChild(e) {
            let t = this.flatItems[e];
            return (
              t && 'group' === t.type && (t = t.items[0]), (t && a(`[${yo}="${t.id}"]`)) || null
            );
          }
          get activeItem() {
        ...
        fo([fe.observable], go.prototype, 'activeItemIdx', 2),
          fo([fe.observable], go.prototype, 'sideBarOpened', 2),
          fo([fe.action], go.prototype, 'toggleSidebar', 1),
          fo([fe.action], go.prototype, 'closeSidebar', 1),
          fo([fe.action], go.prototype, 'activate', 1),
          fo([fe.action.bound], go.prototype, 'activateAndScroll', 1);
        ...
        ((e, t, r, n) => {
          for (var o, i = xo(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && bo(t, r, i);
        })([we.bind, jt(100)], wo.prototype, 'handleScroll');
        class Oo {
          constructor() {
...
`,
  ...
  `};
`,
          $o = { 1: '1.85714em', 2: '1.57143em', 3: '1.27em' },
          Co = e => Z`
...
`;
        function zo(t) {
          return e.createElement(Fo, { to: t.to });
        }
        const Bo = { left: '90deg', right: '-90deg', up: '-180deg', down: '0' };
        class Qo extends e.PureComponent {
          render() {
            return e.createElement(
              'svg',
              {
...
`;
        var si = require('@redocly/react-dropdown-aria');
        const ai = ne(r.n(si)())`
  && {
    box-sizing: border-box;
    min-width: 100px;
...
`;
        var yi = require('perfect-scrollbar'),
          gi = r.n(yi),
        ...
        s &&
          ((ki = r(433)),
          (ki = ('function' == typeof ki.toString && ki.toString()) || ''),
          (ki = '[object Object]' === ki ? '' : ki));
        const Si = K`${ki}`,
          Ri = ne.div`
  position: relative;
`;
        class ji extends e.Component {
          ...
          componentDidMount() {
            ...
            (this.inst = new Ei(this._container, this.props.options || {})),
          ...
          return e.createElement(de.Consumer, null, r =>
            r.nativeScrollbars
              ...
              : e.createElement(
                  ji,
                  ((e, t) => {
                    for (var r in t || (t = {})) vi.call(t, r) && Oi(e, r, t[r]);
                    if (xi) for (var r of xi(t)) wi.call(t, r) && Oi(e, r, t[r]);
                    return e;
                  })({}, t),
                  t.children,
                ),
        ...
        var Ci = Object.defineProperty,
          ...
          Li = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        function Di(t) {
          const { Label: r = ci, Dropdown: n = li } = t;
          return 1 === t.options.length
            ? e.createElement(r, null, t.options[0].value)
            : e.createElement(
                n,
                ((o = ((e, t) => {
                  for (var r in t || (t = {})) Ti.call(t, r) && Li(e, r, t[r]);
                  if (Ii) for (var r of Ii(t)) _i.call(t, r) && Li(e, r, t[r]);
                  return e;
                })({}, t)),
                Pi(o, Ai({ searchable: !1 }))),
              );
          var o;
        }
        var Mi = require('dompurify');
        const Ni = Z`
  a {
        ...
        var Fi = Object.defineProperty,
          ...
          Ui = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        const Wi = qi.withComponent('span');
        function Vi(t) {
          const r = t.inline ? Wi : qi;
          return e.createElement(he, null, n => {
            return e.createElement(
              r,
              ((e, t) => {
                for (var r in t || (t = {})) Bi.call(t, r) && Ui(e, r, t[r]);
                if (zi) for (var r of zi(t)) Qi.call(t, r) && Ui(e, r, t[r]);
                return e;
              })(
                {
                  className: 'redoc-markdown ' + (t.className || ''),
                  dangerouslySetInnerHTML: {
                    __html: ((o = n.untrustedSpec), (i = t.html), o ? Mi.sanitize(i) : i),
                  },
...
`;
        ...
        class ts {
          ...
          static copyElement(e) {
            ts.selectElement(e);
            const t = ts.copySelected();
            return t && ts.deselect(), t;
          }
          static copyCustom(e) {
            ...
            (t.style.position = 'fixed'),
              ...
              t.select();
            const r = ts.copySelected();
            return document.body.removeChild(t), r;
          }
        }
        class rs extends e.PureComponent {
          constructor(t) {
            super(t),
              (this.copy = () => {
                const e =
                ...
                ts.copyCustom(e), this.showTooltip();
              }),
              (this.renderCopyButton = () =>
                e.createElement(
                  ...
                  e.createElement(
                    Ki,
                    {
                      title: ts.isSupported() ? 'Copied' : 'Not supported in your browser',
        ...
        function cs(e, t) {
          ...
          return (
            null == e
              ? (n += as('null', 'token keyword'))
              : e && e.constructor === Array
              ? (ns++,
                (n += (function (e, t) {
                  const r = ns > t ? 'collapsed' : '';
                  let n = `<button class="collapser" aria-label="${
                      ns > t + 1 ? 'expand' : 'collapse'
                    }"></button>${ls(
                      '[',
                  ...
                  for (let s = 0; s < i; s++)
                    (o = !0),
                      ...
                      s < i - 1 && (n += ','),
                      (n += '</div></li>');
                  return (n += `</ul>${ls(']')}`), o || (n = ls('[ ]')), n;
                })(e, t)),
                ns--)
              : e && e.constructor === Date
              ? (n += as('"' + e.toISOString() + '"', 'token string'))
              : 'object' === r
              ? (ns++,
                (n += (function (e, t) {
                  const r = ns > t ? 'collapsed' : '',
                  ...
                  for (let a = 0; a < o; a++) {
                    ...
                    (s = !0),
                      ...
                      (i += '<span class="property token string">"' + is(l) + '"</span>: '),
                      (i += cs(e[l], t)),
                      a < o - 1 && (i += ls(',')),
                      (i += '</div></li>');
                  }
                  return (i += `</ul>${ls('}')}`), s || (i = ls('{ }')), i;
                })(e, t)),
                ns--)
              : 'number' === r
              ? (n += as(e, 'token number'))
              ...
              ? /^(http|https):\/\/[^\s]+$/.test(e)
                ? (n +=
                    ...
                    '</a>' +
                    as('"', 'token string'))
                : (n += as('"' + ss(e) + '"', 'token string'))
              : 'boolean' === r && (n += as(e, 'token boolean')),
            n
          );
        }
        const ps = Z`
...
`;
        class ds extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.renderInner = ({ renderCopyButton: t }) =>
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    null,
                    t(),
                    e.createElement('button', { onClick: this.expandAll }, ' Expand all '),
                    e.createElement('button', { onClick: this.collapseAll }, ' Collapse all '),
                  ),
                  e.createElement(de.Consumer, null, t =>
                    e.createElement(di, {
                      className: this.props.className,
                      ref: e => (this.node = e),
                      dangerouslySetInnerHTML: {
                        __html: os(this.props.data, t.jsonSampleExpandLevel),
                      },
                    }),
                  ),
                )),
          ...
          render() {
            return e.createElement(rs, { data: this.props.data }, this.renderInner);
          }
          componentDidMount() {
  ...
  ${ps};
`;
        class hs extends e.PureComponent {
          render() {
            const { source: t, lang: r } = this.props;
            return e.createElement(fi, { dangerouslySetInnerHTML: { __html: Rt(t, r) } });
          }
        }
        class fs extends e.Component {
          render() {
            return e.createElement(rs, { data: this.props.source }, ({ renderCopyButton: t }) =>
              e.createElement(
                hi,
                null,
                e.createElement(mi, null, t()),
                e.createElement(hs, { lang: this.props.lang, source: this.props.source }),
              ),
            );
          }
        }
        function ys({ value: t, mimeType: r }) {
          return Ve(r)
            ? e.createElement(ms, { data: t })
            : ('object' == typeof t && (t = JSON.stringify(t, null, 2)),
              e.createElement(fs, { lang: tt(r), source: t }));
        }
        function gs({ example: t, mimeType: r }) {
          return void 0 === t.value && t.externalValueUrl
            ? e.createElement(bs, { example: t, mimeType: r })
            : e.createElement(ys, { value: t.value, mimeType: r });
        }
        function bs({ example: t, mimeType: r }) {
          ...
          return void 0 === n
            ...
            : e.createElement(ys, { value: n, mimeType: r });
        }
        const xs = ne.div`
  padding: 0.9em;
        ...
        class ks extends e.Component {
          ...
          render() {
            const { activeIdx: t } = this.state,
              ...
              o = e.createElement(Es, null, 'No sample'),
              i = Object.keys(r);
            ...
            if (i.length > 1) {
              ...
              return e.createElement(
                ...
                e.createElement(
                  ws,
                  null,
                  e.createElement(vs, null, 'Example'),
                ...
                e.createElement(
                  'div',
                  null,
                  a && e.createElement(Hi, { source: a }),
                  e.createElement(gs, { example: s, mimeType: n }),
                ),
              );
            }
            {
              ...
              return e.createElement(
                Ss,
                null,
                t.description && e.createElement(Hi, { source: t.description }),
                e.createElement(gs, { example: t, mimeType: n }),
              );
            }
          }
        }
...
`;
        let zs = class extends e.Component {
          render() {
        ...
        class Bs extends e.PureComponent {
          constructor() {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                r ? M('enumArray') : '',
                ' ',
                1 === t.length ? M('enumSingleValue') : M('enum'),
                ':',
              ),
              ' ',
              s.map((t, r) => {
                const n = o ? String(t) : JSON.stringify(t);
                return e.createElement(e.Fragment, { key: r }, e.createElement(Ds, null, n), ' ');
              }),
              a
                ? e.createElement(
                    Qs,
...
`,
  ...
  margin: 2px 0;
`;
        class Ws extends e.PureComponent {
          render() {
                ...
                r.showExtensions &&
                  Object.keys(t).map(r =>
                    e.createElement(
                      Us,
                      { key: r },
                      e.createElement($s, null, ' ', r.substring(2), ': '),
                      ' ',
                      e.createElement(
                        Ms,
                        null,
        ...
        function Vs({ field: t }) {
          return t.examples
            ? e.createElement(
                e.Fragment,
                null,
                e.createElement($s, null, ' ', M('examples'), ': '),
                e.createElement(
                  Hs,
                  null,
                  Object.values(t.examples).map((r, n) =>
                    e.createElement(
                      'li',
                      { key: n },
                      e.createElement(Ds, null, et(t, r.value)),
                      ' -',
                      ' ',
...
`;
        class Js extends e.PureComponent {
          render() {
            return 0 === this.props.constraints.length
              ...
              : e.createElement(
                  ...
                  null,
                  ' ',
                  this.props.constraints.map(t => e.createElement(Ns, { key: t }, ' ', t, ' ')),
                );
          }
        }
        const Ys = e.memo(function ({ value: t, label: r, raw: n }) {
          if (void 0 === t) return null;
          const o = n ? String(t) : JSON.stringify(t);
          return e.createElement(
            'div',
            null,
            e.createElement($s, null, ' ', r, ' '),
            ' ',
            e.createElement(Ds, null, o),
          );
        });
        function Gs(t) {
        ...
        function Xs({ schema: t }) {
          return !t || ('string' === t.type && !t.constraints.length)
            ...
            : e.createElement(
                ...
                null,
                '[ items',
                t.displayFormat && e.createElement(Is, null, ` &lt;${t.displayFormat}&gt; `),
                e.createElement(Js, { constraints: t.constraints }),
                e.createElement(Gs, { schema: t }),
                t.items && e.createElement(Xs, { schema: t.items }),
                ' ]',
              );
        }
        const Zs = ne(Cs)`
        ...
        var Ks = Object.defineProperty,
          ...
          na = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          oa = (e, t) => {
            for (var r in t || (t = {})) ta.call(t, r) && na(e, r, t[r]);
            if (ea) for (var r of ea(t)) ra.call(t, r) && na(e, r, t[r]);
            return e;
          };
        const ia = e.memo(function (t) {
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              a.displayFormat && e.createElement(Is, null, ' ', '<', a.displayFormat, '>', ' '),
              a.contentEncoding && e.createElement(Is, null, ' ', '<', a.contentEncoding, '>', ' '),
              a.contentMediaType &&
                e.createElement(Is, null, ' ', '<', a.contentMediaType, '>', ' '),
              a.title && !n && e.createElement(As, null, ' (', a.title, ') '),
              e.createElement(Js, { constraints: a.constraints }),
              e.createElement(Gs, { schema: a }),
              a.isCircular && e.createElement(_s, null, ' ', M('recursive'), ' '),
              m && a.items && e.createElement(Xs, { schema: a.items }),
            ),
            c &&
              e.createElement(
                'div',
                null,
                e.createElement(Wo, { type: 'warning' }, ' ', M('deprecated'), ' '),
              ),
            e.createElement(Ys, { raw: h, label: M('default') + ':', value: a.default }),
            !s && e.createElement(Bs, { isArrayType: m, values: a.enum }),
            ' ',
            f,
            e.createElement(Ws, { extensions: oa(oa({}, p), a.extensions) }),
            e.createElement('div', null, e.createElement(Hi, { compact: !0, source: l })),
            a.externalDocs && e.createElement(zs, { externalDocs: a.externalDocs, compact: !0 }),
            (s && s(t)) || null,
            (d && e.createElement(Ys, { label: M('const') + ':', value: d })) || null,
          );
        });
...
`;
          ...
          render() {
            ...
            return !t.displayType || r || n.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(oi, null, ' Array ', n),
                  e.createElement(
                    ma,
                    null,
                    e.createElement(
                      Qa,
                      ((o = ((e, t) => {
                        for (var r in t || (t = {})) pa.call(t, r) && da(e, r, t[r]);
                        if (ca) for (var r of ca(t)) ua.call(t, r) && da(e, r, t[r]);
                        return e;
                      })({}, this.props)),
                      aa(o, la({ schema: r }))),
                    ),
              ...
              u = c
                ? e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(Uo, { direction: p ? 'down' : 'right' }),
                    ),
                    a && e.createElement(Ts, null, ' required '),
                  )
                : e.createElement(
                    Go,
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ia,
                    ((e, t) => {
                      for (var r in t || (t = {})) ga.call(t, r) && xa(e, r, t[r]);
                      if (ya) for (var r of ya(t)) ba.call(t, r) && xa(e, r, t[r]);
                      return e;
                    })({}, this.props),
                  ),
                ),
        ...
        var Ea = Object.defineProperty,
          ...
          Aa = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Sa(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && Ea(t, r, i), i;
          };
        let Ia = class extends e.Component {
          constructor() {
            super(...arguments),
              (this.activateOneOf = () => {
          ...
          render() {
            ...
            return e.createElement(
              ni,
              { active: t === r.activeOneOf, onClick: this.activateOneOf },
              n.title || n.typePrefix + n.displayType,
            );
          }
        };
        Ia = Aa([Rs.observer], Ia);
          ...
          render() {
            ...
            return void 0 === t
              ...
              : e.createElement(
                  'div',
                  null,
                  e.createElement(ri, null, ' ', r.oneOfType, ' '),
                  e.createElement(
                    ti,
                    null,
                    t.map((t, n) =>
                      e.createElement(Ia, { key: t.pointer, schema: r, subSchema: t, idx: n }),
                    ),
                  ),
                  e.createElement(
                    Qa,
                    ((n = ((e, t) => {
                      for (var r in t || (t = {})) $a.call(t, r) && Pa(e, r, t[r]);
                      if (ja) for (var r of ja(t)) Ca.call(t, r) && Pa(e, r, t[r]);
                      return e;
                    })({}, this.props)),
        ...
        Ta = Aa([Rs.observer], Ta);
        var _a = Object.defineProperty,
          La = Object.defineProperties,
          Da = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          ...
          Fa = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          za = (e, t) => {
            for (var r in t || (t = {})) Na.call(t, r) && Fa(e, r, t[r]);
            if (Ma) for (var r of Ma(t)) qa.call(t, r) && Fa(e, r, t[r]);
            return e;
          },
          Ba = (e, t) => La(e, Da(t));
        let Qa = class extends e.Component {
          render() {
            ...
            const r = this.props,
              ...
              o = ((e, t) => {
                var r = {};
                for (var n in e) Na.call(e, n) && t.indexOf(n) < 0 && (r[n] = e[n]);
                if (null != e && Ma)
                  for (var n of Ma(e)) t.indexOf(n) < 0 && qa.call(e, n) && (r[n] = e[n]);
                return r;
              })(r, ['schema']),
              i = (o.level || 0) + 1;
            ...
            if (c)
              return e.createElement(
                ...
                n.title && e.createElement(As, null, ' ', n.title, ' '),
                e.createElement(_s, null, ' ', M('recursive'), ' '),
              );
            if (void 0 !== l)
              return a && a.length
                ? e.createElement(
                ...
                : (console.warn(
                  ...
                  null);
            if (void 0 !== a) return e.createElement(Ta, za({ schema: n }, o));
            const p = Array.isArray(s) ? s : [s];
            if (p.includes('object')) {
              if (null == (t = n.fields) ? void 0 : t.length)
                return e.createElement(Oa, Ba(za({}, this.props), { level: i }));
            } else if (p.includes('array'))
              return e.createElement(ha, Ba(za({}, this.props), { level: i }));
            const u = {
              schema: n,
              name: '',
              required: !1,
            ...
            return e.createElement('div', null, e.createElement(ia, { field: u }));
          }
        };
        Qa = ((e, t, r, n) => {
          for (var o, i = t, s = e.length - 1; s >= 0; s--) (o = e[s]) && (i = o(i) || i);
        ...
        var Ua = Object.defineProperty,
          ...
          Ja = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        class Ya extends e.PureComponent {
          constructor() {
            super(...arguments),
          ...
          get mediaModel() {
            ...
            return (
              this._mediaModel ||
                (this._mediaModel = new en(e, 'json', !1, Ya.getMediaType(t, r), n)),
              this._mediaModel
            );
          }
          render() {
...
`,
                ...
                e.createElement(
                  ...
                  Object.keys(r.scopes || {}).map(t =>
                    e.createElement(
                      ...
                      ' - ',
                      e.createElement(Hi, { inline: !0, source: r.scopes[t] || '' }),
                    ),
                  ),
                ),
              ),
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(Hi, { source: t.description || '' }),
                    e.createElement(
                      qi,
                      null,
                      e.createElement(
                        ...
                        e.createElement(
                          ...
                          e.createElement(
                            ...
                            e.createElement('td', null, ' ', Xa[t.type] || t.type, ' '),
                          ),
                          t.apiKey
                            ? e.createElement(
                                'tr',
                            ...
                            ? Object.keys(t.flows).map(r =>
                                e.createElement(Za, { key: r, type: r, flow: t.flows[r] }),
                              )
                            : null,
                        ),
                      ),
        ...
        function tl(e, t) {
          return el(this, arguments, function* (e, t, r = {}) {
        ...
        class rl {
          constructor(e, t, r = {}, n = !0) {
            (this.marker = new Jt()),
              (this.disposer = null),
              (this.rawOptions = r),
              (this.options = new Y(r, nl)),
              (this.scroll = new wo(this.options)),
              go.updateOnHistory(Vt.currentId, this.scroll),
              (this.spec = new Gn(e, t, this.options)),
              (this.menu = new go(this.spec, this.scroll, Vt)),
          ...
          static fromJS(e) {
            const t = new rl(e.spec.data, e.spec.url, e.options, !1);
            return (
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let cl = class extends e.Component {
          constructor() {
            super(...arguments),
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  Eo,
                  { className: 'api-info' },
                  e.createElement(ol, null, r.title, ' ', u),
                  !o &&
                    e.createElement(
                      'p',
                      null,
                  ...
                  e.createElement(
                    ...
                    ((r.license || r.contact || r.termsOfService) &&
                      e.createElement(
                        al,
                        null,
                        e.createElement(ll, null, c, ' ', l, ' ', a, ' ', p),
                      )) ||
                      null,
                  ),
                  e.createElement(Hi, {
                  ...
                  n && e.createElement(zs, { externalDocs: n }),
                ),
              ),
            );
          }
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let ml = class extends e.Component {
          render() {
            ...
            const n = r.href || (t.contact && t.contact.url),
              ...
              i = e.createElement(pl, { src: r.url, alt: o });
            return e.createElement(
              ul,
              { style: { backgroundColor: r.backgroundColor } },
              n ? ((s = n), t => e.createElement(dl, { href: s }, t))(i) : i,
            );
            var s;
          }
        };
        ...
        var hl = Object.defineProperty,
          ...
          bl = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          xl = (e, t) => {
            for (var r in t || (t = {})) yl.call(t, r) && bl(e, r, t[r]);
            if (fl) for (var r of fl(t)) gl.call(t, r) && bl(e, r, t[r]);
            return e;
          };
        class vl extends e.Component {
          render() {
            return e.createElement(he, null, t =>
              e.createElement(Do, null, e => this.renderWithOptionsAndStore(t, e)),
            );
          }
          renderWithOptionsAndStore(t, r) {
            ...
            const i = new cr(t).renderMdWithComponents(n);
            return i.length
              ? i.map((t, n) =>
                  'string' == typeof t
                    ? e.cloneElement(o(e.createElement(Vi, { html: t, inline: !1, compact: !1 })), {
                        key: n,
                      })
                    : e.createElement(
                        t.component,
                        xl({ key: n }, xl(xl({}, t.props), t.propsSelector(r))),
                      ),
                )
              : null;
          }
        }
        var wl = require('classnames'),
          Ol = r.n(wl);
        const El = ne.span.attrs(e => ({ className: `operation-type ${e.type}` }))`
  width: 9ex;
  display: inline-block;
...
`;
        function kl(e, { theme: r }) {
          return e > 1
            ? (0, t.darken)(0.1, r.sidebar.backgroundColor)
            : 1 === e
            ? (0, t.darken)(0.05, r.sidebar.backgroundColor)
            : '';
        }
        const Sl = ne.ul`
  margin: 0;
...
`,
  ...
  `,
          ...
          $l = ne.label.attrs(e => ({
            role: 'menuitem',
            className: Ol()('-depth' + e.depth, { active: e.active }),
          }))`
  cursor: pointer;
        ...
        class Al extends e.PureComponent {
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(_l, { type: i }, xt(i)),
              e.createElement(Uo, {
                size: '1.5em',
                direction: r ? 'down' : 'right',
                float: 'left',
              }),
              e.createElement(Tl, { deprecated: s }, t),
              s ? e.createElement(Wo, { type: 'warning' }, ' ', M('deprecated'), ' ') : null,
            );
          }
        }
        const Il = ne.button`
...
`;
                ...
                e.createElement(
                  ...
                  t.servers.map(r => {
                    ...
                    return e.createElement(
                      Ql,
                      { key: o },
                      e.createElement(Hi, { source: r.description || '', compact: !0 }),
                      e.createElement(
                        Ml,
                        null,
                        e.createElement(
        ...
        class Vl extends e.PureComponent {
          render() {
            ...
            return r && r.length
              ? e.createElement(
                  'div',
                  { key: t },
                  e.createElement(To, null, t, ' Parameters'),
                  e.createElement(
                    ei,
                    null,
                    e.createElement(
                      ...
                      null,
                      v(r, (t, r) =>
                        e.createElement(va, { key: t.name, isLast: r, field: t, showExamples: !0 }),
                      ),
                    ),
                  ),
                )
            ...
            const r = t.activeMimeIdx,
              ...
              o = ({ children: t }) =>
                this.props.withLabel
                  ? e.createElement(ws, null, e.createElement(vs, null, 'Content type'), t)
                  : t;
            return e.createElement(
              e.Fragment,
              null,
        ...
        var Jl = Object.defineProperty,
          ...
          Zl = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        const Kl = ['path', 'query', 'cookie', 'header'];
        class ec extends e.PureComponent {
          ...
          render() {
            ...
            return e.createElement(
              e.Fragment,
              null,
              o.map(t => e.createElement(Vl, { key: t, place: t, parameters: n[t] })),
              i && e.createElement(rc, { content: i, description: s }),
            );
          }
        }
        function tc(t) {
          return e.createElement(
            ...
            e.createElement(
              Di,
              ((e, t) => {
                for (var r in t || (t = {})) Gl.call(t, r) && Zl(e, r, t[r]);
                if (Yl) for (var r of Yl(t)) Xl.call(t, r) && Zl(e, r, t[r]);
                return e;
              })({}, t),
            ),
          );
        ...
        function rc(t) {
          const { content: r, description: n } = t,
            { isRequestType: o } = r;
          return e.createElement(Hl, { content: r, renderDropdown: tc }, ({ schema: t }) =>
            e.createElement(
              e.Fragment,
              null,
              void 0 !== n && e.createElement(Hi, { source: n }),
              e.createElement(Qa, { skipReadOnly: o, skipWriteOnly: !o, key: 'schema', schema: t }),
            ),
          );
        }
        const nc = e.memo(function ({
            title: t,
            type: r,
            empty: n,
            code: o,
            ...
            return e.createElement(
              ...
              e.createElement(ac, null, o, ' '),
              e.createElement(Hi, { compact: !0, inline: !0, source: t }),
            );
          }),
          oc = ne(nc)`
  display: block;
...
`,
  ...
  vertical-align: top;
`;
        class lc extends e.PureComponent {
          render() {
            ...
            return void 0 === t || 0 === t.length
              ...
              : e.createElement(
                  ei,
                  null,
                  e.createElement(sc, null, ' Response Headers '),
                  e.createElement(
                    'tbody',
                    null,
                    v(t, (t, r) =>
                      e.createElement(va, { isLast: r, key: t.name, field: t, showExamples: !0 }),
                    ),
                  ),
                );
          }
        ...
        var cc = Object.defineProperty,
          ...
          mc = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        class hc extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t =>
                e.createElement(
                  ...
                  e.createElement(
                    Di,
                    ((e, t) => {
                      for (var r in t || (t = {})) uc.call(t, r) && mc(e, r, t[r]);
                      if (pc) for (var r of pc(t)) dc.call(t, r) && mc(e, r, t[r]);
                      return e;
                    })({}, t),
                  ),
                ));
          ...
          render() {
            ...
            return e.createElement(
              e.Fragment,
              null,
              t && e.createElement(Hi, { source: t }),
              e.createElement(Ws, { extensions: r }),
              e.createElement(lc, { headers: n }),
              e.createElement(
                Hl,
                { content: o, renderDropdown: this.renderDropdown },
                ({ schema: t }) =>
                  e.createElement(Qa, { skipWriteOnly: !0, key: 'schema', schema: t }),
              ),
            );
          }
        }
        const fc = (0, Rs.observer)(({ response: t }) => {
            const {
                extensions: r,
                headers: n,
                type: o,
            ...
            return e.createElement(
              ...
              l && !u && e.createElement(ic, null, e.createElement(hc, { response: t })),
            );
          }),
          yc = ne.h3`
  font-size: 1.3em;
  ...
  font-weight: normal;
`;
        class gc extends e.PureComponent {
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(yc, null, M(r ? 'callbackResponses' : 'responses')),
                  t.map(t => e.createElement(fc, { key: t.code, response: t })),
                )
              : null;
          }
        }
...
`,
  ...
  ${Ni};
`;
        class wc extends e.PureComponent {
          render() {
              ...
              t.schemes.length
                ? t.schemes.map(t =>
                    e.createElement(
                      ...
                      t.scopes.length > 0 && ' (',
                      t.scopes.map(t => e.createElement(bc, { key: t }, t)),
                      t.scopes.length > 0 && ') ',
                    ),
                  )
                : e.createElement(xc, null, 'None'),
            );
          }
        }
        const Oc = ne.div`
          ...
          render() {
            ...
            return t.length
              ? e.createElement(
                  Sc,
                  null,
                  e.createElement(Oc, null, e.createElement(kc, null, 'Authorizations: ')),
                  e.createElement(
                    Ec,
                    null,
                    t.map((t, r) => e.createElement(wc, { key: r, security: t })),
                  ),
                )
              : null;
          }
            ...
            return e.createElement(
              ...
              o &&
                e.createElement(
                  $c,
                  null,
                  void 0 !== r && e.createElement(Hi, { source: r }),
                  n && e.createElement(zs, { externalDocs: n }),
                ),
              e.createElement(Wl, { operation: this.props.operation, inverted: !0, compact: !0 }),
              e.createElement(Ws, { extensions: t.extensions }),
              e.createElement(Rc, { securities: t.security }),
              e.createElement(ec, { parameters: t.parameters, body: t.requestBody }),
              e.createElement(gc, { responses: t.responses, isCallback: t.isCallback }),
            );
          }
        };
        jc = ((e, t, r, n) => {
        ...
        let Cc = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              r && e.createElement(jc, { operation: this.props.callbackOperation }),
            );
          }
        };
        Cc = ((e, t, r, n) => {
          ...
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(Ac, null, ' Callbacks '),
                  t.map(t =>
                    t.operations.map((r, n) =>
                      e.createElement(Cc, { key: `${t.name}_${n}`, callbackOperation: r }),
                    ),
                  ),
                )
              : null;
...
`;
        ...
        let Ic = class extends e.Component {
          ...
          render() {
            ...
            const r = ({ children: t }) =>
              this.props.label
                ? e.createElement(ws, null, e.createElement(vs, null, this.props.label), t)
                : t;
            return e.createElement(
              e.Fragment,
              null,
        ...
        var Tc = Object.defineProperty,
          _c = (Object.getOwnPropertyDescriptor, Object.getOwnPropertySymbols),
          ...
          Mc = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        let Nc = class extends e.Component {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t =>
                e.createElement(
                  Di,
                  ((e, t) => {
                    for (var r in t || (t = {})) Lc.call(t, r) && Mc(e, r, t[r]);
                    if (_c) for (var r of _c(t)) Dc.call(t, r) && Mc(e, r, t[r]);
                    return e;
                  })({ Label: xs, Dropdown: Os }, t),
                ));
          }
          render() {
        ...
        class qc extends e.Component {
          render() {
            const t = this.props.callback.codeSamples.find(e => vn(e));
            return t
              ? e.createElement(Fc, null, e.createElement(Nc, { content: t.requestBodyContent }))
              : null;
          }
        }
        const Fc = ne.div`
...
`;
        var zc = Object.defineProperty,
          Bc = (Object.getOwnPropertyDescriptor, Object.getOwnPropertySymbols),
        ...
        let Vc = class extends e.Component {
            ...
            super(...arguments),
              (this.renderDropdown = t =>
                e.createElement(
                  Di,
                  ((e, t) => {
                    for (var r in t || (t = {})) Qc.call(t, r) && Wc(e, r, t[r]);
                    if (Bc) for (var r of Bc(t)) Uc.call(t, r) && Wc(e, r, t[r]);
                    return e;
                  })({ Label: xs, Dropdown: Os }, t),
                ));
          }
          render() {
            ...
            return e.createElement(
              'div',
              null,
              e.createElement(Io, null, ' Callback payload samples '),
              e.createElement(
                Hc,
                null,
                e.createElement(
            ...
            return (
              (n &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(Io, null, ' ', M('requestSamples'), ' '),
                  e.createElement(
                    ui,
                    { defaultIndex: 0 },
                    e.createElement(
                      ...
                      e.createElement(
                        ...
                        vn(t)
                          ? e.createElement(
                              'div',
                              null,
                              e.createElement(Nc, { content: t.requestBodyContent }),
                            )
                          : e.createElement(fs, { lang: t.lang, source: t.source }),
                      ),
                    ),
                  ),
                )) ||
            ...
            return (
              (r.length > 0 &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(Io, null, ' ', M('responseSamples'), ' '),
                  e.createElement(
                    ui,
                    { defaultIndex: 0 },
                    e.createElement(
                    ...
                    r.map(t =>
                      e.createElement(
                        pi.TabPanel,
                        { key: t.code },
                        e.createElement('div', null, e.createElement(Nc, { content: t.content })),
                      ),
                    ),
                  ),
                )) ||
...
`;
        let Xc = class extends e.Component {
          render() {
            const { operation: t } = this.props,
              ...
              a = !(!n && !i);
            return e.createElement(de.Consumer, null, l =>
              e.createElement(
                jo,
                null,
                e.createElement(
                  ...
                  e.createElement(
                    Ao,
                    null,
                    e.createElement(zo, { to: t.id }),
                    r,
                    ' ',
                    o && e.createElement(Wo, { type: 'warning' }, ' Deprecated '),
                    s && e.createElement(Wo, { type: 'primary' }, ' Webhook '),
                  ),
                  l.pathInMiddlePanel && !s && e.createElement(Wl, { operation: t, inverted: !0 }),
                  a &&
                    e.createElement(
                      Gc,
                      null,
                      void 0 !== n && e.createElement(Hi, { source: n }),
                      i && e.createElement(zs, { externalDocs: i }),
                    ),
                  e.createElement(Ws, { extensions: t.extensions }),
                  e.createElement(Rc, { securities: t.security }),
                  e.createElement(ec, { parameters: t.parameters, body: t.requestBody }),
                  e.createElement(gc, { responses: t.responses }),
                  e.createElement(Pc, { callbacks: t.callbacks }),
                ),
                e.createElement(
                  Ro,
                  null,
                  !l.pathInMiddlePanel && !s && e.createElement(Wl, { operation: t }),
                  e.createElement(Jc, { operation: t }),
                  e.createElement(Yc, { operation: t }),
                  e.createElement(Vc, { callbacks: t.callbacks }),
                ),
              ),
            );
          }
        ...
        var Zc = Object.defineProperty,
          ...
          op = (e, t) => {
            ...
            if (ep) for (var r of ep(t)) rp.call(t, r) && np(e, r, t[r]);
            return e;
          },
          ip = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Kc(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && Zc(t, r, i), i;
          };
        let sp = class extends e.Component {
          render() {
            const t = this.props.items;
            return 0 === t.length ? null : t.map(t => e.createElement(ap, { key: t.id, item: t }));
          }
        };
        sp = ip([Rs.observer], sp);
        let ap = class extends e.Component {
          render() {
            ...
            switch (n) {
              ...
              case 'tag':
              case 'section':
                r = e.createElement(cp, op({}, this.props));
                break;
              case 'operation':
                r = e.createElement(pp, { item: t });
                break;
              default:
                r = e.createElement(cp, op({}, this.props));
            }
            return e.createElement(
              ...
              t.items && e.createElement(sp, { items: t.items }),
            );
          }
        };
        ap = ip([Rs.observer], ap);
        const lp = t => e.createElement(Eo, { compact: !0 }, t);
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  Eo,
                  { compact: !1 },
                  e.createElement(i, null, e.createElement(zo, { to: this.props.item.id }), t),
                ),
              ),
              e.createElement(vl, { source: r || '', htmlWrap: lp }),
              n &&
                e.createElement(
                  jo,
                  null,
                  e.createElement(Eo, null, e.createElement(zs, { externalDocs: n })),
                ),
            );
          }
        };
        cp = ip([Rs.observer], cp);
        let pp = class extends e.Component {
          render() {
            return e.createElement(Xc, { operation: this.props.item });
          }
        };
        pp = ip([Rs.observer], pp);
        var up = Object.defineProperty,
          ...
          bp = (e, t, r) =>
            t in e
              ? up(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r),
          xp = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? mp(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            ...
            return e.createElement(
              ...
              'operation' === t.type
                ? e.createElement(
                    wp,
                    ((n = ((e, t) => {
                      for (var r in t || (t = {})) yp.call(t, r) && bp(e, r, t[r]);
                      if (fp) for (var r of fp(t)) gp.call(t, r) && bp(e, r, t[r]);
                      return e;
                    })({}, this.props)),
                    dp(n, hp({ item: t }))),
                  )
        ...
        let wp = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              t.isWebhook
                ? e.createElement(El, { type: 'hook' }, M('webhook'))
                : e.createElement(El, { type: t.httpVerb }, xt(t.httpVerb)),
              e.createElement(
                Cl,
                { width: 'calc(100% - 38px)' },
                t.sidebarLabel,
        ...
        wp = xp([Rs.observer], wp);
        var Op = Object.defineProperty,
          Ep = (Object.getOwnPropertyDescriptor, Object.getOwnPropertySymbols),
        ...
        let jp = class extends e.Component {
          render() {
            ...
            return e.createElement(
              Sl,
              ((e, t) => {
                for (var r in t || (t = {})) kp.call(t, r) && Rp(e, r, t[r]);
                if (Ep) for (var r of Ep(t)) Sp.call(t, r) && Rp(e, r, t[r]);
                return e;
              })(
              ...
              t.map((t, r) =>
                e.createElement(vp, { key: r, item: t, onActivate: this.props.onActivate }),
              ),
            );
          }
        };
        ...
        let $p = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(jp, { items: t.items, onActivate: this.activate, root: !0 }),
              e.createElement(
                Pl,
                null,
                e.createElement(
        ...
        const Cp = ({ open: t }) => {
          ...
          Pp = ({ size: t = 10, className: r = '', style: n }) =>
            e.createElement(
              'svg',
              {
                className: r,
...
`;
        let Dp = class extends e.Component {
          ...
          componentDidMount() {
            Tp && Tp.add(this.stickyElement),
              this.setState({ offsetTop: this.getScrollYOffset(this.context) });
          }
          componentWillUnmount() {
            Tp && Tp.remove(this.stickyElement);
          }
          getScrollYOffset(e) {
            let t;
            return (
              (t =
                void 0 !== this.props.scrollYOffset
                  ? Y.normalizeScrollYOffset(this.props.scrollYOffset)()
                  : e.scrollYOffset()),
              t + 'px'
            );
          }
...
`;
        ...
        class Hp extends e.PureComponent {
          constructor(e) {
            super(e),
          ...
          render() {
            ...
            return (
              ...
              e.createElement(
                Fp,
                { role: 'search' },
                this.state.term && e.createElement(Up, { onClick: this.clear }, '×'),
                e.createElement(Bp, null),
                e.createElement(zp, {
                ...
                this.state.term && this.state.noResults
                  ? e.createElement(Qp, { 'data-role': 'search:results' }, M('noResultsFound'))
                  : null,
              )
            );
          }
        ...
        ((e, t, r, n) => {
          for (var o, i = Vp(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && Wp(t, r, i);
        })([we.bind, (0, we.debounce)(400)], Hp.prototype, 'searchCallback');
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(ml, { info: t.info }),
                      (!n.disableSearch &&
                        e.createElement(Hp, {
                          search: o,
                          marker: i,
                        ...
                        null,
                      e.createElement($p, { menu: r }),
                    ),
                    e.createElement(
                      Np,
                      { className: 'api-content' },
                      e.createElement(cl, { store: s }),
                      e.createElement(sp, { items: r.items }),
                    ),
                    e.createElement(qp, null),
                  ),
                ),
              ),
            );
        ...
        Jp.propTypes = { store: ue.instanceOf(rl).isRequired };
        const Yp = function (t) {
          const { spec: r, specUrl: n, options: o = {}, onLoaded: i } = t,
            s = H(o.hideLoading, !1),
            a = new Y(o);
          return e.createElement(
            se,
            ...
            e.createElement(
              Mo,
              { spec: r, specUrl: n, options: o, onLoaded: i },
              ({ loading: t, store: r }) =>
                t
                  ? s
                    ? null
                    : e.createElement(pe, { color: a.theme.colors.primary.main })
                  : e.createElement(Jp, { store: r }),
            ),
          );
        };
      })(),
