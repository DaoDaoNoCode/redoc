...
`,$o=ne.div`
  ...
  `};
`,Co={1:"1.85714em",2:"1.57143em",3:"1.27em"},Po=e=>Z`
...
`,Is=ne(Cs)`
  ...
  word-break: break-word;
`,Ts=As,_s=ne(Cs.withComponent("div"))`
...
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Pc=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(Dl,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement($c,{operation:this.props.callbackOperation}))}};Pc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([js.observer],Pc);class Ac extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Ic,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(Pc,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const Ic=ne.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
